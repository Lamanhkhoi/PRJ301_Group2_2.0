...
<aside class="w-64 bg-[#1E293B] text-white flex flex-col justify-between z-10">
    ...
    <form action="../LogoutController" method="POST">
        <div class="px-3 mb-6">
            ...
            <button type="submit"
                    class="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-slate-300 hover:bg-red-500/20 hover:text-red-400 transition-colors border-t border-slate-700 mt-4">
