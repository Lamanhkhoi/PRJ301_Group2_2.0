...
<html lang="vi">
    ...
    <body class="bg-[#F8FAFC] text-gray-800">
        ...
        <div id="alertBox" class="mb-4 px-4 py-3 rounded-lg border <%= "success".equals(alertType) ? "bg-green-50 border-green-300 text-green-700" : "bg-red-50 border-red-300 text-red-700"%>">
