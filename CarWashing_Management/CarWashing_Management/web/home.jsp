...
<head>
    ...
    <style>
        ...
        h1, h2, .font-heading { font-family: 'Montserrat', sans-serif; }
        .bg-primary { background-color: #464BE5; }
    </style>
</head>
    ...
    <section class="relative flex items-center px-10 py-20 min-h-[80vh] overflow-hidden">
        ...
        <div class="relative z-10 max-w-2xl text-white">
            ...
            <div class="flex gap-4">
                <a href="#dat-lich" class="px-8 py-3 bg-primary hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg transition duration-300">
                    Đặt lịch ngay
                </a>
